...
from .utils import CONFIG_DATA, create_config_model
...
class NilAIConfig(BaseModel):
    ...
    environment: EnvironmentConfig = create_config_model(EnvironmentConfig, "", CONFIG_DATA)
    ...
    redis: RedisConfig = create_config_model(RedisConfig, "redis", CONFIG_DATA, "REDIS_")
    ...
    nildb: NilDBConfig = create_config_model(NilDBConfig, "nildb", CONFIG_DATA, "NILDB_")
